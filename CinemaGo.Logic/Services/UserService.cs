...
namespace CinemaGo.Logic.Services
{
    public class UserService : IUserService
    {
        ...
        public ContactModel SaveContact(ContactModel newContact)
        {
            try
            {
                Contact _contact = new Contact();
                _contact.FirstName = newContact.FirstName;
                _contact.LastName = newContact.LastName;
                _contact.Email = newContact.Email;
                _contact.PhoneNumber = newContact.PhoneNumber;
                _contact.Comment = newContact.Comment;
                _dBContext.Add(_contact);
        ...
        public List<ProductModel> GetProductByCinemaId(int cinemaId)
        {
            var data = _dBContext.Products.Where(x => x.CinemaId == cinemaId).ToList();
