...
namespace CinemaGo.Admin.Services
{
    public class AdminPanelService : IAdminPanelService
    {
        ...
        {
            return await httpClient.GetJsonAsync<List<ContactModel>>("api/admin/GetContacts");
        }

        public async Task<bool> DeleteContact(ContactModel contactToDelete)
        {
            return await httpClient.PostJsonAsync<bool>("api/admin/DeleteContact", contactToDelete);
        }

        public async Task<List<OrderDetailModel>> GetOrderDetails()
        {
            return await httpClient.GetJsonAsync<List<OrderDetailModel>>("api/admin/GetOrderDetails");
        }

        public async Task<bool> DeleteOrderDetail(OrderDetailModel orderdetailToDelete)
        {
            return await httpClient.PostJsonAsync<bool>("api/admin/DeleteOrderDetail", orderdetailToDelete);
        }
    }
}
