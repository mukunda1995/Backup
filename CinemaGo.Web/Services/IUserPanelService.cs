...
namespace CinemaGo.Web.Services
{
    public interface IUserPanelService
    {
        ...
        Task<List<ProductModel>> GetProductByCinemaId(int cinemaId);
        ...
        Task<ContactModel> SaveContact(ContactModel newContact);

        Task<List<ContactModel>> GetContacts();

        Task<bool> UpdateContact(ContactModel contactToUpdate);
